...
export interface ApiBannerGroupBannerGroup extends Struct.CollectionTypeSchema {
  collectionName: 'banner_groups';
  info: {
    description: '';
    displayName: 'BannerGroup';
    pluralName: 'banner-groups';
    singularName: 'banner-group';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    teaser_groups: Schema.Attribute.Relation<
      'oneToMany',
      'api::teaser-group.teaser-group'
    >;
    TeaserName: Schema.Attribute.String;
    UID: Schema.Attribute.UID;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiContactFormContactForm extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    WhyDoYouWantToConnectFor: Schema.Attribute.String;
  };
}
...
export interface ApiCustomPostCustomPost extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    CTALinkBlog: Schema.Attribute.String;
    CTALinkNewsRoom: Schema.Attribute.String;
    CTALinkPressRelease: Schema.Attribute.String;
    CTAText: Schema.Attribute.String;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::custom-post.custom-post'
    > &
      Schema.Attribute.Private;
    Post: Schema.Attribute.Component<'post.post', false>;
    publishedAt: Schema.Attribute.DateTime;
    SectionDescription: Schema.Attribute.Text;
    SectionTitle: Schema.Attribute.String;
    UID: Schema.Attribute.UID;
...
export interface ApiFooterConfigFooterConfig extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    DisclimerLink: Schema.Attribute.String;
    DisclimerText: Schema.Attribute.String;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
...
export interface ApiMainMenuMainMenu extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    SEOKeywords: Schema.Attribute.String;
    SEOTitle: Schema.Attribute.String;
    ShowOnFooter: Schema.Attribute.Boolean & Schema.Attribute.DefaultTo<false>;
    ShowOnHeader: Schema.Attribute.Boolean & Schema.Attribute.DefaultTo<false>;
    SortMenu: Schema.Attribute.Integer;
    SortMenuFooter: Schema.Attribute.Integer;
...
export interface ApiMediaGroupMediaGroup extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    video: Schema.Attribute.Relation<
      'oneToOne',
      'plugin::mux-video-uploader.mux-asset'
    >;
  };
...
export interface ApiStatsCountStatsCount extends Struct.CollectionTypeSchema {
  collectionName: 'stats_counts';
  info: {
    description: '';
    displayName: 'StatsCount';
    pluralName: 'stats-counts';
    singularName: 'stats-count';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::stats-count.stats-count'
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    StatsCounts: Schema.Attribute.Component<'stats.stats-name', true>;
    Title: Schema.Attribute.String;
    UID: Schema.Attribute.UID;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
...
export interface ApiTeaserGroupTeaserGroup extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    media_groups: Schema.Attribute.Relation<
      'oneToMany',
      'api::media-group.media-group'
    >;
    publishedAt: Schema.Attribute.DateTime;
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::stats-count.stats-count': ApiStatsCountStatsCount;
      'api::submenu.submenu': ApiSubmenuSubmenu;
      'api::teaser-group.teaser-group': ApiTeaserGroupTeaserGroup;
